...
const Storiessection = () => {
  return (
    <section className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-12 px-6 sm:px-8 py-12 sm:py-16 mt-16 bg-white">
      ...
      <div className="absolute top-[120px] bottom-[59px] right-0 left-1/3 bg-[#F8F8F8] rounded-l-[20px] z-0 hidden lg:block"></div>
      ...
      <div className="relative z-10">
        <p className="text-red-600 text-sm uppercase tracking-wide mb-1.5 underline decoration-[#BC153F] decoration-2 underline-offset-2 pt-8 sm:pt-16">
          Stories
        </p>
        ...
        <p className="text-[#5C5C5C] leading-[1.3] mb-4 text-[12.5px] sm:text-sm font-rubik">
        ...
        <p className="text-[#5C5C5C]  leading-[1.3] text-[12.5px] sm:text-sm font-rubik">
