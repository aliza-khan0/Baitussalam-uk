...
const VideoSection = () => {
  ...
  Real Stories
      ...
      <p className="text-gray-600 mt-2 mb-8 text-sm">
        Watch how your generosity brings hope, care, and change to those who need it most.
      </p>

      {/* Main Video */}
      <div className="relative w-full max-w-5xl mx-auto rounded-xl overflow-hidden mb-10 h-64 md:h-94">
  <video
    ref={videoRef}
