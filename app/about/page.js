...
<section className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-5 lg:gap-12 px-6 sm:px-12 lg:px-[8%] py-10  bg-white md:mt-19  ">
  ...
  <div className="relative z-10 flex justify-center lg:justify-start mt-9 lg:mt-0">
    <div className="relative w-full min-h-[300px] lg:min-h-[390px]">
      {/* Back Image */}
      <img
        src="/mission.png"
        alt="Building"
        className="w-[90%] max-w-[400px] h-[400px] lg:w-full lg:max-w-[420px] lg:h-[440px] rounded-[20px]  mx-auto lg:mx-0"
      />
...
<section className="relative bg-white text-center overflow-hidden py-16 sm:py-20 px-4 sm:px-12 font-sans">
  ...
  <div className="hidden sm:block absolute top-[65%] left-0 transform -translate-y-1/2 w-32 sm:w-40 h-32 sm:h-40 bg-[#22305B] rounded-tr-[60px] rounded-br-[60px] z-0"></div>

  {/* Right Blue Background — hidden on small screens */}
  <div className="hidden sm:block absolute top-[65%] right-0 transform -translate-y-1/2 w-32 sm:w-40 h-32 sm:h-40 bg-[#22305B] rounded-tl-[60px] rounded-bl-[60px] z-0"></div>
    ...
    {[
      ...
      >
        <div className="bg-[#b2173f] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-2 sm:mb-3">
         <img src={item.img} alt={item.title} className="w-5 h-5 sm:w-8 sm:h-8 object-contain" />
