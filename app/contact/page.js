...
/>
  ...
  <div className="hidden sm:block absolute top-[50%] left-0 transform -translate-y-1/2 w-32 sm:w-40 h-32 sm:h-40 bg-[#22305B] rounded-tr-[60px] rounded-br-[60px] z-0"></div>

  {/* Right Blue Background */}
  <div className="hidden sm:block absolute top-[50%] right-0 transform -translate-y-1/2 w-32 sm:w-40 h-32 sm:h-40 bg-[#22305B] rounded-tl-[60px] rounded-bl-[60px] z-0"></div>
  ...
  <div className="relative z-10 flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8">
    {[
      ...
      <div
        key={i}
        className="bg-[#FBFBFB] shadow-md rounded-[15px] w-52 sm:w-56 md:w-60 h-48 sm:h-52 md:h-52 p-4 sm:p-6 text-center flex flex-col items-center justify-center border-8 border-white rounded-lg"

      >
        <div className="bg-[#b2173f] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-2 sm:mb-3">
          <img src={item.img} alt={item.title} className="w-7 h-7 sm:w-8 sm:h-8 object-contain" />
        </div>
